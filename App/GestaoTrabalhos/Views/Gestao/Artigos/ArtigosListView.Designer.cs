namespace GestaoTrabalhos.Views.Gestao.Artigos
{
	partial class ArtigosListView
	{
		...
		private void InitializeComponent()
		{
			...
			this.colPrecoUnit = new DevExpress.XtraGrid.Columns.GridColumn();
			this.colNotas = new DevExpress.XtraGrid.Columns.GridColumn();
			this.colStockAtual = new DevExpress.XtraGrid.Columns.GridColumn();
			...
			this.xucArtigosDetailView = new GestaoTrabalhos.Views.Gestao.Artigos.ArtigosDetailView();
			...
			this.barDockControlTop.Size = new System.Drawing.Size(1066, 39);
			// 
			...
			this.barDockControlRight.Location = new System.Drawing.Point(1066, 39);
			...
			this.navigationFrame.Size = new System.Drawing.Size(1066, 788);
			...
			this.npList.Size = new System.Drawing.Size(1066, 788);
			// 
			// layoutControl
			// 
			...
			this.layoutControl.Size = new System.Drawing.Size(1066, 788);
			...
			this.panelControl.Size = new System.Drawing.Size(1048, 768);
			this.panelControl.TabIndex = 4;
			// 
			// gridControl
			// 
			this.gridControl.DataSource = this.artigosEntityBindingSource;
			...
			this.gridControl.Size = new System.Drawing.Size(1044, 764);
			...
			this.colNome.Width = 412;
			// 
			// colPrecoUnit
			// 
			this.colPrecoUnit.FieldName = "PrecoUnit";
			this.colPrecoUnit.MinWidth = 23;
			this.colPrecoUnit.Name = "colPrecoUnit";
			this.colPrecoUnit.Visible = true;
			this.colPrecoUnit.VisibleIndex = 2;
			this.colPrecoUnit.Width = 258;
			// 
			// colNotas
			// 
			...
			this.colNotas.Width = 303;
			// 
			// colStockAtual
			// 
			this.colStockAtual.FieldName = "StockAtual";
			this.colStockAtual.MinWidth = 23;
			this.colStockAtual.Name = "colStockAtual";
			this.colStockAtual.Visible = true;
			this.colStockAtual.VisibleIndex = 3;
			this.colStockAtual.Width = 141;
			// 
			// colAtivo
			// 
			...
			this.Root.Size = new System.Drawing.Size(1066, 788);
			...
			this.layoutControlItem.Size = new System.Drawing.Size(1054, 776);
			this.layoutControlItem.TextVisible = false;
			// 
			// npEditor
			// 
			this.npEditor.Caption = "npEditor";
			this.npEditor.Controls.Add(this.xucArtigosDetailView);
			this.npEditor.Margin = new System.Windows.Forms.Padding(4, 4, 4, 4);
			this.npEditor.Name = "npEditor";
			this.npEditor.Size = new System.Drawing.Size(1066, 788);
			// 
			// xucArtigosDetailView
			// 
			this.xucArtigosDetailView.Dock = System.Windows.Forms.DockStyle.Fill;
			this.xucArtigosDetailView.Location = new System.Drawing.Point(0, 0);
			this.xucArtigosDetailView.Margin = new System.Windows.Forms.Padding(5, 5, 5, 5);
			this.xucArtigosDetailView.Name = "xucArtigosDetailView";
			this.xucArtigosDetailView.Size = new System.Drawing.Size(1066, 788);
			this.xucArtigosDetailView.TabIndex = 0;
			// 
			// ArtigosListView
			// 
			...
			this.Name = "ArtigosListView";
			this.Size = new System.Drawing.Size(1066, 827);
		...
		private DevExpress.XtraGrid.Columns.GridColumn colPrecoUnit;
		private DevExpress.XtraGrid.Columns.GridColumn colNotas;
		private DevExpress.XtraGrid.Columns.GridColumn colStockAtual;
		...
		private ArtigosDetailView xucArtigosDetailView;
	}
}
