...
{
	partial class ArtigosDetailView
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			this.artigosEntityBindingSource = new System.Windows.Forms.BindingSource(this.components);
			...
			((System.ComponentModel.ISupportInitialize)(this.artigosEntityBindingSource)).BeginInit();
			...
			this.dataLayoutControl.Controls.Add(this.spinEdit11);
			this.dataLayoutControl.DataSource = this.artigosEntityBindingSource;
			...
			this.dataLayoutControl.Margin = new System.Windows.Forms.Padding(4, 4, 4, 4);
			this.dataLayoutControl.Name = "dataLayoutControl";
			this.dataLayoutControl.Root = this.Root;
			this.dataLayoutControl.Size = new System.Drawing.Size(979, 752);
			...
			this.toggleSwitch1.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", this.artigosEntityBindingSource, "Ativo", true));
			this.toggleSwitch1.Location = new System.Drawing.Point(119, 128);
			...
			this.CodigoTextEdit.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", this.artigosEntityBindingSource, "Codigo", true));
			this.CodigoTextEdit.Location = new System.Drawing.Point(119, 52);
			this.CodigoTextEdit.Margin = new System.Windows.Forms.Padding(4, 4, 4, 4);
			this.CodigoTextEdit.Name = "CodigoTextEdit";
			this.CodigoTextEdit.Size = new System.Drawing.Size(209, 30);
			this.CodigoTextEdit.StyleController = this.dataLayoutControl;
			this.CodigoTextEdit.TabIndex = 12;
			// 
			// artigosEntityBindingSource
			// 
			this.artigosEntityBindingSource.DataSource = typeof(DataService.Entities.ArtigosEntity);
			// 
			// NomeTextEdit
			// 
			this.NomeTextEdit.CausesValidation = false;
			this.NomeTextEdit.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", this.artigosEntityBindingSource, "Nome", true));
			this.NomeTextEdit.Location = new System.Drawing.Point(435, 52);
			this.NomeTextEdit.Margin = new System.Windows.Forms.Padding(4, 4, 4, 4);
			...
			this.NomeTextEdit.Size = new System.Drawing.Size(526, 30);
			...
			this.IdTextEdit.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", this.artigosEntityBindingSource, "Id", true));
			this.IdTextEdit.Location = new System.Drawing.Point(48, 702);
			this.IdTextEdit.Margin = new System.Windows.Forms.Padding(4, 4, 4, 4);
			...
			this.IdTextEdit.Size = new System.Drawing.Size(154, 30);
			...
			this.DataCriacaoDateEdit.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", this.artigosEntityBindingSource, "DataCriacao", true));
			this.DataCriacaoDateEdit.EditValue = null;
			this.DataCriacaoDateEdit.Location = new System.Drawing.Point(300, 702);
			this.DataCriacaoDateEdit.Margin = new System.Windows.Forms.Padding(4, 4, 4, 4);
			...
			this.DataCriacaoDateEdit.Size = new System.Drawing.Size(281, 30);
			...
			this.DataAtualizacaoDateEdit.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", this.artigosEntityBindingSource, "DataAtualizacao", true));
			this.DataAtualizacaoDateEdit.EditValue = null;
			this.DataAtualizacaoDateEdit.Location = new System.Drawing.Point(701, 702);
			this.DataAtualizacaoDateEdit.Margin = new System.Windows.Forms.Padding(4, 4, 4, 4);
			...
			this.DataAtualizacaoDateEdit.Size = new System.Drawing.Size(260, 30);
			...
			this.NotasTextEdit.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", this.artigosEntityBindingSource, "Notas", true));
			this.NotasTextEdit.Location = new System.Drawing.Point(12, 208);
			this.NotasTextEdit.Margin = new System.Windows.Forms.Padding(4, 4, 4, 4);
			this.NotasTextEdit.Name = "NotasTextEdit";
			this.NotasTextEdit.Size = new System.Drawing.Size(955, 438);
			...
			this.spinEdit2.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", this.artigosEntityBindingSource, "PrecoUnit", true));
			this.spinEdit2.EditValue = new decimal(new int[] {
            0,
            0,
            0,
            0});
			this.spinEdit2.Location = new System.Drawing.Point(593, 90);
			...
			this.spinEdit2.Size = new System.Drawing.Size(368, 30);
			this.spinEdit2.StyleController = this.dataLayoutControl;
			this.spinEdit2.TabIndex = 15;
			// 
			// spinEdit11
			// 
			this.spinEdit11.CausesValidation = false;
			this.spinEdit11.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", this.artigosEntityBindingSource, "StockAtual", true));
			this.spinEdit11.EditValue = new decimal(new int[] {
            0,
            0,
            0,
            0});
			this.spinEdit11.Location = new System.Drawing.Point(119, 90);
			this.spinEdit11.Margin = new System.Windows.Forms.Padding(4, 4, 4, 4);
            ...
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			this.spinEdit11.Properties.MaskSettings.Set("mask", "d");
			this.spinEdit11.Properties.UseMaskAsDisplayFormat = true;
			this.spinEdit11.Size = new System.Drawing.Size(367, 30);
			this.spinEdit11.StyleController = this.dataLayoutControl;
			this.spinEdit11.TabIndex = 14;
			// 
			// Root
			// 
			...
			this.Root.Size = new System.Drawing.Size(979, 752);
			...
			this.layoutControlGroup1.Size = new System.Drawing.Size(967, 740);
			// 
			// layoutControlGroup2
			// 
            ...
            this.ItemForId});
			this.layoutControlGroup2.Location = new System.Drawing.Point(0, 648);
			...
			this.layoutControlGroup2.Size = new System.Drawing.Size(967, 92);
			this.layoutControlGroup2.Spacing = new DevExpress.XtraLayout.Utils.Padding(3, 3, 6, 4);
			this.layoutControlGroup2.Text = "Detalhes";
			// 
			// ItemForDataCriacao
			// 
			this.ItemForDataCriacao.Control = this.DataCriacaoDateEdit;
			this.ItemForDataCriacao.Location = new System.Drawing.Point(190, 0);
			this.ItemForDataCriacao.Name = "ItemForDataCriacao";
			this.ItemForDataCriacao.Size = new System.Drawing.Size(379, 38);
			this.ItemForDataCriacao.Text = "Data Criacao";
			this.ItemForDataCriacao.TextSize = new System.Drawing.Size(73, 16);
			// 
			// ItemForDataAtualizacao
			// 
			this.ItemForDataAtualizacao.Control = this.DataAtualizacaoDateEdit;
			this.ItemForDataAtualizacao.Location = new System.Drawing.Point(569, 0);
			this.ItemForDataAtualizacao.Name = "ItemForDataAtualizacao";
			this.ItemForDataAtualizacao.Size = new System.Drawing.Size(380, 38);
			this.ItemForDataAtualizacao.Text = "Data Atualizacao";
			this.ItemForDataAtualizacao.TextSize = new System.Drawing.Size(95, 16);
			// 
			// ItemForId
			// 
			...
			this.ItemForId.Size = new System.Drawing.Size(190, 38);
			this.ItemForId.Text = "Id";
			this.ItemForId.TextSize = new System.Drawing.Size(11, 16);
			// 
			// layoutControlGroup3
			// 
			...
			this.layoutControlGroup3.Size = new System.Drawing.Size(967, 488);
			this.layoutControlGroup3.Spacing = new DevExpress.XtraLayout.Utils.Padding(3, 3, 6, 4);
			...
			this.ItemForNotas.Size = new System.Drawing.Size(961, 446);
			...
			this.layoutControlGroup4.Size = new System.Drawing.Size(967, 160);
			this.layoutControlGroup4.Text = "Principal";
			// 
			// ItemForNome
			// 
			this.ItemForNome.Control = this.NomeTextEdit;
			this.ItemForNome.Location = new System.Drawing.Point(316, 0);
			this.ItemForNome.Name = "ItemForNome";
			this.ItemForNome.Size = new System.Drawing.Size(633, 38);
			this.ItemForNome.Text = "Nome";
			this.ItemForNome.TextSize = new System.Drawing.Size(82, 16);
			// 
			// layoutControlItem1
			// 
			...
			this.layoutControlItem1.Size = new System.Drawing.Size(316, 38);
			...
			this.layoutControlItem2.Text = "Artigo Ativo";
			this.layoutControlItem2.TextSize = new System.Drawing.Size(82, 16);
			// 
			// emptySpaceItem1
			// 
			this.emptySpaceItem1.Location = new System.Drawing.Point(164, 76);
			this.emptySpaceItem1.Name = "emptySpaceItem1";
			this.emptySpaceItem1.Size = new System.Drawing.Size(785, 32);
			// 
			// layoutControlItem4
			// 
			this.layoutControlItem4.AppearanceItemCaption.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F);
			this.layoutControlItem4.AppearanceItemCaption.Options.UseFont = true;
			this.layoutControlItem4.AppearanceItemCaptionDisabled.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F);
			...
			this.layoutControlItem4.CustomizationFormText = "Custo (€)";
			this.layoutControlItem4.Location = new System.Drawing.Point(474, 38);
			this.layoutControlItem4.Name = "layoutControlItem4";
			this.layoutControlItem4.OptionsPrint.AppearanceItem.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F);
			this.layoutControlItem4.OptionsPrint.AppearanceItem.Options.UseFont = true;
			this.layoutControlItem4.OptionsPrint.AppearanceItemControl.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F);
			this.layoutControlItem4.OptionsPrint.AppearanceItemControl.Options.UseFont = true;
			this.layoutControlItem4.OptionsPrint.AppearanceItemText.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F);
			this.layoutControlItem4.OptionsPrint.AppearanceItemText.Options.UseFont = true;
			this.layoutControlItem4.Size = new System.Drawing.Size(475, 38);
			this.layoutControlItem4.Text = "Preço Unitário (€)";
			this.layoutControlItem4.TextSize = new System.Drawing.Size(82, 13);
			// 
			// layoutControlItem3
			// 
			this.layoutControlItem3.AppearanceItemCaption.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F);
			this.layoutControlItem3.AppearanceItemCaption.Options.UseFont = true;
			this.layoutControlItem3.AppearanceItemCaptionDisabled.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F);
			...
			this.layoutControlItem3.CustomizationFormText = "Duração (min)";
			...
			this.layoutControlItem3.Size = new System.Drawing.Size(474, 38);
			this.layoutControlItem3.Text = "Stock Atual";
			...
			this.Name = "ArtigosDetailView";
			this.Size = new System.Drawing.Size(979, 752);
			...
			((System.ComponentModel.ISupportInitialize)(this.artigosEntityBindingSource)).EndInit();
		...
		private System.Windows.Forms.BindingSource artigosEntityBindingSource;
